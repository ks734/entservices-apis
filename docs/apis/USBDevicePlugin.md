...
| :-------- | :-------- | :-------- |
| params | object |  |
| params.deviceClass | integer | USB class of the device |
| params.deviceSubclass | integer | USB Sub class of the device |
| params.deviceName | string | Name of the USB device |
| params.devicePath | string | The path to be used for the USB device |
